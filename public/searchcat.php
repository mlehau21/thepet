...
<main>  
		<h2 class="text-center" >Tra cứu thông tin các loài mèo</h2>
        <div>
            <form class="text-center" action="searchcat.php" method="get">
            <label for="search">Nhập tên giống mèo: </label>
